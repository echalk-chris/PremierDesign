(function($, exports){
  ...
  exports.drawSlideShow = function(templates, data, selector, modalSelector, cdnUrl) {
    ...
    var annData = _.map(data.data, function (obj) {
      ...
      if(cdnUrl === null || typeof cdnUrl == 'undefined') {
        cdnUrl = 'static1cdn.echalk.net';
      }
      if(obj.Image !== null && typeof obj.Image !== 'undefined' &&
         obj.Image.Path !== null && typeof obj.Image.Path !== 'undefined') {
          var dest = 'http://' + cdnUrl + '/www'
          obj.Image.Path = obj.Image.Path.replace(/http:\/\/[^\/]*\/www/gi,dest);
      }
  ...
  exports.drawArchive = function(templates, data, selector, modalSelector) {
    ...
    html = Mustache.to_html(templates.ArchiveModal.join(" "), data);
    $(modalSelector).append(html);
