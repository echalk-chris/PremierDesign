...
$(document).ready(function() {
	...
	$('#header').load("http://nicholson.sd129.org/www/nicholson/site/hosting/pd/header.html", function(){
		var siteId = '8c193c53-06aa-4299-ba55-fcf884cf21ae';
	...
	$('.footer').load("http://nicholson.sd129.org/www/nicholson/site/hosting/pd/footer.html");
