...
$(document).ready(function() {
	...
	$('#header').load("http://herget.sd129.org/www/herget/site/hosting/pd/header.html", function(){
		var siteId = '8875d8cc-d52d-4bb6-9ca8-62a96cccdfe6';
	...
	$('.footer').load("http://herget.sd129.org/www/herget/site/hosting/pd/footer.html");
