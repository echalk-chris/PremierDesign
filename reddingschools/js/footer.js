...
$(document).ready(function() {
	...
	$('#header').load("http://www.reddingschools.net/www/redding/site/hosting/pd/header.html", function(){
		var siteId = '04e6052d-5586-11d7-b398-00d0b79e88ef';
	...
	$('.footer').load("http://www.reddingschools.net/www/redding/site/hosting/pd/footer.html");
